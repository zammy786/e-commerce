...
<title>FIZZY Shopping/Entertainment</title>
...
<div style="width:100%; height:auto;">
  ...
  <!--menu--> <div style="height:45px; width:100%; background-color:#F0E68C; border:0px solid #269FB2;">
...
<!--slider down data-->
            ...
            <table style="height:auto; width:1050px; margin:auto; margin-bottom:10px;   border:0px solid #000000; background-color:#F0E68C; ">
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
                        ...
                        <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; font-size:18px; background-color:#c0c0c0;border-radius:5px; "><p style="margin-left:20px; margin-top:1px;"><b> Our Products</b></p></div>      
			 ...
			 $query="select * from product where pro_cat='tv'";
		...
		?>
               ...
               <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:150px; width:230px; float:left;border:0px solid #000000;border-radius:15px; margin-top:10px;" align="center"><img src="images/<?php echo $row['image1'];?>"                     height="130" width="190"></div> 
