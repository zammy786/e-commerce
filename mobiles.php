...
<title>FIZZY Shopping/Mobiles</title>
...
<!--slider down data-->
            ...
            <div style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color:#FFFFFF; margin-bottom:10px; margin-top:10px; ">
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%% % MOBILES  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='mobile'";
		...
		?>
                  ...
                  <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:170px; width:230px; margin-top:10px; float:left;border:0px solid #000000;border-radius:15px;" align="center"><img src="images/<?php echo $row['image1'];?>"                     height="140" width="180"></div> 
