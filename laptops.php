...
<title>FIZZY Shopping/laptops</title>
...
<!--slider down data-->
            ...
            <table style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color:#FFFFFF; ">
			 ...
			 $query="select * from product where pro_cat='laptop'";
		...
		?>
                   ...
                   <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:170px; width:230px; border:0px solid #000000;border-radius:15px;margin-top:10px;" align="center"><img src="images/<?php echo $row['image1'];?>"                     height="140" width="190" ></div> 
