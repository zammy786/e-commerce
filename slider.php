    ...
    <div id="wrapper"  >
        ...
        <div id="zoom-slider" style="height:280px; margin-top:0px; width:1140px;">

            <img src="images/slider2.png" alt="" height="300" width="1200" />

            <img src="images/slider1.png" alt="" height="300" width="1200" />

           

                <img src="images/imm.PNG" alt="" height="300" width="1200" /></a>
                
   <img src="images/og.PNG" alt="" height="300" width="1200" /></a>
        </div>

        <!--The following are custom navigation buttons-->

        <div style="width:1120px;background:black;padding: 4px 8px 8px 10px; border-radius:0 0 6px 6px; text-align:right; margin-left:1px;">
            ...
            <span id="thumbs" style="  width:500px;">
                ...
                <span><img src="images/imm.png"height="35" width="70"  /></span>

              
<span><img src="images/og.png"height="35" width="70"  /></span>
