...
<!--slider down data-->
            ...
            <div style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color:#F0E68C; ">

            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        

                        <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  TV  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->  

                        <div style="height:30px; width:1050px; border:0px solid #000000; color:#000000; font-size:18px; background-color:#c0c0c0;border-radius:5px; margin-top:10px; "><p style="margin-left:20px; margin-top:0px;"><b>HOT OFFERS</b></p></div>      
